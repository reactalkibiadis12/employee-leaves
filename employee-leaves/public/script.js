...
async function loadEmployees() {
    ...
    if (selectedEmployee) {
        ...
        document.getElementById("totalSickDays").value = selectedEmployee.total_sick_days || DEFAULT_SICK_DAYS;
        document.getElementById("totalOtherDays").value = selectedEmployee.total_other_days || DEFAULT_OTHER_DAYS;
        await updateTotals();
    }
}
...
async function showDetails(id) {
    ...
    document.getElementById("totalSickDays").value = data.total_sick_days || DEFAULT_SICK_DAYS;
    document.getElementById("totalOtherDays").value = data.total_other_days || DEFAULT_OTHER_DAYS;
...
async function updateTotals() {
    ...
    const totalSickDays = parseInt(document.getElementById("totalSickDays").value) || DEFAULT_SICK_DAYS;
    const totalOtherDays = parseInt(document.getElementById("totalOtherDays").value) || DEFAULT_OTHER_DAYS;
    ...
    document.getElementById("totalSickDays").value = totalSickDays;
    document.getElementById("remainingSickDays").textContent = remainingSickDays;
    document.getElementById("totalOtherDays").value = totalOtherDays;
    ...
    const { error } = await supabase
        ...
        .update({
            ...
            total_other_days: totalOtherDays
        })
